...
figure(2),clf
plot(Node(1,Surface_Nodes)*L_char, L_char*(Node(2,Surface_Nodes)+U_char*UVPv(Surface_Nodes,1)'),'.')

hold
figure(3),clf
plot(Node(1,Surface_Nodes)*L_char, L_char*(Node(2,Surface_Nodes)+U_char*UVPu(Surface_Nodes,1)'),'.')
hold
